...
impl DatabaseSettings {
    pub fn without_db(&self) -> PgConnectOptions {
        let ssl_mode = if self.require_ssl {
            ...
            // Try an encrypted connection, fallback to
            // unenvrypted if it fails
            PgSslMode::Prefer
        };
...
pub fn get_configuration(
    ...
    let settings = config::Config::builder()
        ...
        // Add in settings from environment variables (with
        // a prefix of APP and '__' as separator)
        // E.g. `APP_APPLICATION__PORT=5001 would set
...
/// The possible runtime environment for our
/// application.
